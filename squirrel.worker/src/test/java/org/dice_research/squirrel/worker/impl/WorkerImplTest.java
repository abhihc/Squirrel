//source code taken from branch : Integration of test case to check the 3 approaches written in order to make the fetcher and analyzer run parallelly inside the worker.
